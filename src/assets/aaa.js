    ...
    this.subStage = [
      {
        id: 1,
        label: 'JavaSE 基础',
        describe: '打好Java基础才能真正成为Java开发的高手，学习Java企业级技术和项目才能游刃有余。',
  ...
  case 2:
    this.subStage = [
      ...
      },
      {
        id: 9,
        label: 'Vue 开发',
        describe: '掌握多行业解决方案，项目开发拿来即用，帮你搞定前端工程师必备热门框架Vue.js。',
        targetList: [
          { id: 30, name: 'Node.js' },
  ...
  case 6:
    this.subStage = [
      ...
      },
      {
        id: 25,
        label: 'UI自动化',
        describe: 'ui自动化大体分为web自动化和app自动化，在自动化测试领域中占比很大，经常使用。',
        targetList: [
          { id: 55, name: 'web自动化测试' },
      ...
      },
      {
        id: 28,
        label: '综合项目强化',
        describe: '通过微信小程序、金融项目两个实战项目综合强化功能测试、接口测试、性能测试。',
